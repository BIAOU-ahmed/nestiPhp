...
class BaseController1
{
    ...
    protected static function render($templateName, $vars = [])
    {
        if ($templateName == null) {
            ...
            $vars = array_merge($vars, [
                ...
                'templatesPath' => SiteUtil::toAbsolute("app/view/$templateName.php"),
                'mainTemplatePath' => SiteUtil::toAbsolute("app/view/$templateNames.php"),
    ...
    {
        self::render("list", [
            'entities' => get_called_class()::$dao::findAll()
        ]);
    }
