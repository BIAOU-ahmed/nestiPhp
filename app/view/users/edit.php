                            ...
                            <div class="py-4  px-8">
                                ...
                                <div class="border h-5/6">
                                    ...
                                    <?php if ($vars["entity"]->isChef()) { ?>
                                        ...
                                        <span>Nombre de recette: <?= $vars["entity"]->getChef()->getNbRecipe() ?></span>
                                        <br>
                    ...
                    <div class="  ">
                            <table class="mx-5 flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                                ...
                                <tr class="bg-teal-400 flex flex-col text-center flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">
                                    ...
                                    <th class="p-3 " width="110px">Contenu</th>
                                ...
                                foreach ($vars['entity']->getComments() as $comment) {
                                    ...
                                    <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                                        ...
                                        <td class="border-grey-light border hover:bg-gray-100 p-3 w-1/12"><?= $comment->getRecipe()->getName() ?></td>
                                        ...
                                        <td class="border-grey-light border hover:bg-gray-100 p-3 w-1/12">
                                            <span class="rounded <?= $comment->getStateClass($comment) ?> py-1 px-3 text-xs font-bold"><?= $comment->getState($comment) ?></span>
                                        </td>
                                                            ...
                                                            <form
                                                                ...
                                                                <main class="  h-20 grid   p-2 text-center">
                                                                    <p class="w-2/3 justify-self-center bg-white rounded-md">
                                                                        Cette action n'est pas définitive Vous pouvez
