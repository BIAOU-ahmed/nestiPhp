                        ...
                        <div class="py-4 px-8">
                            ...
                            <div class=" mb-4 lg:flex justify-between">
                                <div class=" mr-1 lg:inline-block ">
                                    ...
                                    <div class="invalid-feedback text-red-600">Le code postale doit etre un nombre.
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class=" mr-1 lg:inline-block ">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="grid gap-4 grid-cols-3">
                                    <label class="inline-flex items-center mt-3">
                                        <input <?= $vars['entity']->isAdministrator() ? 'checked' : ''; ?>
                                    ...
                                    <label class="inline-flex items-center mt-3">
                                        <input <?= $vars['entity']->isChef() ? 'checked' : ''; ?> type="checkbox"
                                            name="roles[chef]" value="chef"
                                            class="form-checkbox h-5 w-5 text-purple-600"><span
                                            class="ml-2 text-gray-700">Chef</span>
                                    </label>
                                    <label class="inline-flex items-center mt-3">
                                        <input <?= $vars['entity']->isModerator() ? 'checked' : ''; ?> type="checkbox"
                    ...
                    <div class="inline-block">
                        ...
                        <div class="py-4 px-8">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="invalid-feedback text-red-600">le mot de passe doit avoir au moins un nombre
                                </div>
                                <?php } ?>
                                <?php if (isset($vars["errors"]['password']['haveLower'])) { ?>
                                <div class="invalid-feedback text-red-600">le mot de passe doit avoir au moins une
                                    lettre minuscule </div>
                                <?php } ?>
                                <?php if (isset($vars["errors"]['password']['haveUpper'])) { ?>
                                <div class="invalid-feedback text-red-600">le mot de passe doit avoir au moins une
                                    lettre majuscule </div>
                                <?php } ?>
                                <?php if (isset($vars["errors"]['password']['haveSpecialChar'])) { ?>
                                <div class="invalid-feedback text-red-600">le mot de passe doit avoir au moins un
                                    caractère speciale </div>
                                <?php } ?>
                                <div class="grid">
        ...
        <div class="bg-gray-50 rounded shadow pb-5">
            ...
            <div class="grid gap-5 grid-cols-3">
                ...
                <div class=" ml-3 rounded-lg mb-5  col-span-2 relative">
                    ...
                    <table
                        class="bg-white  border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
                        <thead class="h-20">
                            <tr class="">


                                <th
                                    class="bg-gray-100 sticky top-0 border-b border-gray-200 w-1/12 px-2 text-gray-600 font-bold  uppercase">
                                    ID</th>
                                <th
                                    class="bg-gray-100 sticky top-0 border-b border-gray-200 w-1/6 text-gray-600 font-bold  ">
                                    Utilisateur</th>
                                <th
                                    class="bg-gray-100 sticky top-0 border-b border-gray-200  w-1/6 text-gray-600 font-bold  ">
                                    Montant</th>
        ...
        <div class=" ">
            <div class=" bg-gray-50 rounded shadow pb-5">
                ...
                <div class=" mx-8 rounded-lg mb-5 relative">
                    <table
                        class=" px-4 mb-5 bg-white border-collapse w-full table-auto  whitespace-no-wrap bg-white table-striped relative">
                        <thead class="h-20">
                            <tr class="">
                                ...
                                <td class="border-dashed border-t border-gray-200 grid pt-3">
                                    ...
                                    <div x-data="{ showModal<?= $comment->getIdUsers() ?>: false }"
                                        ...
                                        <main class="flex flex-col sm:flex-row justify-center items-center">
                                            ...
                                            <a class="cursor-pointer underline  text-gray-700 p-2 w-32   "
                                                ...
                                                <div class="relative bg-gray-300 shadow-lg rounded-md text-gray-900 z-20"
                                                    ...
                                                    <form
                                                        ...
                                                        <main class="  h-20 grid   p-2 text-center">
                                                            ...
                                                            Cette action n'est pas définitive Vous pouvez toujours le changer plus tard.
                                                            </p>
                                                        </main>
                                                        <footer class="">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="bg-green-500 ml-5 text-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
                                                                    type="button" style="transition: all .15s ease">
                                                                    <button name="delete" type="submit" value="1"
