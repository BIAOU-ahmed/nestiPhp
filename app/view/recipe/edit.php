    ...
    <div class="bg-grey-lightest">
        <div class=" pt-8">
            <div class=" bg-white rounded shadow">
                <div class="ml-1"><a href="<?=$vars['baseUrl']?>recipe/list">Recettes </a>> Recette</div>
                    ...
                    <form class="" action="<?= $vars['baseUrl'] ?>recipe/edit/<?= $vars["entity"]->getId() ?>" method="post">
                        ...
                        <div class="inline-block">
                            ...
                            <div class="py-4 px-8">
                                <div class="mb-4">
                                    <div class=" mr-1">
                                        <label class="block text-grey-darker text-sm font-bold mb-2" for="name">Nom de
                                            la recette</label>
                                        <input name="Recipe[name]" class="<?= isset($vars["errors"]['name']) ? 'border-red-600' : '' ?> appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="name" type="text" value="<?= $vars["properties"]["name"] ?? $vars['entity']->getName() ?>" placeholder="Le nom de la recette">
                                        <div class="">Auteur de la recette: <?= $vars["entity"]->getChefName() ?>.</div>

                                        <?php if (isset($vars["errors"]['name']['notEmpty'])) { ?>
                                            <div class="invalid-feedback text-red-600">Le nom de la recette est
                                                obligatoire.
                                            </div>
                                        <?php } ?>
                                ...
                                <div class=" mb-4">
                                    <div class=" mr-1 flex justify-between">
                                        <div class="inline-block">
                                            <label class=" text-grey-darker text-sm font-bold mb-2" for="difficulty">Difficulté(note
                                                sur 5)</label>

                                        </div>

                                        <div class="inline-block w-2/6">
                                            <input name="Recipe[difficulty]" class="<?= isset($vars["errors"]['difficulty']) ? 'border-red-600' : '' ?> text-center  appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="difficulty" type="number" value="<?= $vars["properties"]["difficulty"] ?? $vars['entity']->getDifficulty() ?>">
                                        </div>
                                    ...
                                    <?php if (isset($vars["errors"]['difficulty']['uciqueNumber'])) { ?>
                                        <div class="invalid-feedback text-red-600">La difficulter doit etre un nombre
                                            entre [0-5].
                                        </div>
                                    <?php } ?>
                                ...
                                <div class=" mb-4">
                                    <div class=" mr-1  flex justify-between">
                                        <div class="inline-block">
                                            <label class="block text-grey-darker text-sm font-bold mb-2" for="portions">Nombre
                                                de personnes</label>
                                        </div>
                                        <div class="inline-block w-2/6">
                                            <input name="Recipe[portions]" class="<?= isset($vars["errors"]['portions']) ? 'border-red-600' : '' ?> text-center appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="portions" type="number" value="<?= $vars["properties"]["portions"] ?? $vars['entity']->getPortions() ?>">
                                        </div>

                                    </div>
                                    <?php if (isset($vars["errors"]['portions']['notEmpty'])) { ?>
                                        <div class="invalid-feedback text-red-600">Le nombre de personne est
                                            ogligatoire.
                                        </div>
                                    <?php } ?>
                                    <?php if (isset($vars["errors"]['portions']['notEmpty'])) { ?>
                                        <div class="invalid-feedback text-red-600">Le nombre de personnes doit etre un
                                            nombre.
                                        </div>
                                    <?php } ?>
                                ...
                                <div class=" mb-4">
                                    <div class=" mr-1  flex justify-between">
                                        ...
                                        <div class="inline-block w-2/6">
                                            <input name="Recipe[preparationTime]" class="<?= isset($vars["errors"]['preparationTime']) ? 'border-red-600' : '' ?> text-center appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="preparationTime" type="number" value="<?= $vars["properties"]["preparationTime"] ?? $vars['entity']->getPreparationTime()  ?>">
                                        </div>

                                    </div>
                                    <?php if (isset($vars["errors"]['preparationTime']['notEmpty'])) { ?>
                                        <div class="invalid-feedback text-red-600">Le temps de preparation est
                                            necessaire.
                                        </div>
                                    <?php } ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="Recipe[flag]" class="form-select border border-light-blue-500 border-opacity-0 appearance-none rounded mt-1 block w-full py-2 px-3" id="state">
                                        <option value="a" <?= $vars['entity']->getFlag() == 'a' ? 'selected' : ''; ?>>
                                            Actif
                                        </option>
                                        <option value="w" <?= $vars['entity']->getFlag() == 'w' || $vars['entity']->getId() == null ? 'selected' : ''; ?>>
                                            En attente
                                        </option>
                                        <option value="b" <?= $vars['entity']->getFlag() == 'b' ? 'selected' : ''; ?>>
                                            Bloqué
                                        </option>
                                    </select>
                                </div>
                    ...
                    <div class="inline-block h-full">
                        ...
                        <div class="py-4 px-8 h-full">
                            ...
                            <form method="post" class="mb-4 h-full" id="recipeImg" action="<?= $vars['baseUrl'] ?>recipe/addImage">
                                <div>
                                    <img id="image" class="h-80 rounded lg:w-4/5 md:w-full recipe-img  mb-5 bg-gray-300" src="<?= $vars['baseUrl'] ?>public/images/<?= $vars['entity']->getImageName() ?>" alt="" style="height: 20rem;">
                                ...
                                <?php if ($vars['entity']->getId()) { ?>
                                    <div class="lg:w-4/5 flex justify-between">
                                        ...
                                        <div x-data="{ showModal_image: false }" :class="{'overflow-y-hidden': showModal_image }">
                                            <main class="">
                                                <?php
                                                if ($vars['loggedInUser']->getId() == $vars['entity']->getChef()->getId() || $vars['loggedInUser']->isAdministrator()) { ?>
                                                    <button type="button" @click="showModal_image = true" class="delete_btn block"><i class=" rounded text-center pt-1 text-3xl h-10 w-10 bg-red-600 border text-white block fas fa-trash-alt my-2"></i>
                                                    </button>
                                                <?php } ?>
                                            </main>

                                            <!-- Modal1 -->
                                            <div class="delete_modale hidden fixed inset-0 w-full h-full z-20 bg-gray-200 bg-opacity-50 duration-300 overflow-y-auto" x-show="showModal_image" x-transition:enter="transition duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                                                <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3  sm:mx-auto my-10 opacity-100">
                                                    <div class="relative bg-gray-300 shadow-lg rounded-md text-gray-900 z-20" @click.away="showModal_image = false" x-show="showModal_image" x-transition:enter="transition transform duration-300" x-transition:enter-start="scale-0" x-transition:enter-end="scale-100" x-transition:leave="transition transform duration-300" x-transition:leave-start="scale-100" x-transition:leave-end="scale-0">
                                                        ...
                                                        <footer class="">
                                                            ...
                                                            <div class="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b">
                                                                <button class="bg-red-500  active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="button" style="transition: all .15s ease" @click="showModal_image = false">
                                                                    <span class="text-lg"> Annuller </span>
                                                                </button>

                                                                <div @click="showModal_image = false" class="bg-green-500 ml-5 text-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="button" style="transition: all .15s ease">
        ...
        <div class=" pt-8">
            <div class=" bg-white rounded shadow">
                ...
                <div class="grid lg:gap-10 md:gap-1 lg:grid-cols-3 md:grid-cols-5 ">
                    ...
                    <div class="delete_btn inline-block lg:col-span-2 md:col-span-3">
                        <div class="py-4 px-8  text-black lg:text-4xl md:text-3xl  border-grey-lighter">
                                ...
                                <main class="flex w-full flex-col sm:flex-row justify-center items-center">
                                    ...
                                    <div class="w-full ml-15 h-20 mt-5 flex justify-end">
                                        <?php if ($vars['entity']->getId() == '' || $vars['loggedInUser']->getId() == $vars['entity']->getChef()->getId() || $vars['loggedInUser']->isAdministrator()) { ?>
                                            ...
                                            <button id="addprep" class="delete_btn justify-self-end rounded-lg w-11/12 border h-full" @click="showModal = true"><i class="delete_btn text-4xl fas fa-plus"></i>
                                            </button>
                                        <?php } ?>
                                    </div>
                                </main>
                                        ...
                                        <div class="relative bg-gray-300 shadow-lg rounded-md text-gray-900 z-20" @click.away="showModal= false" x-show="showModal" x-transition:enter="transition transform duration-300" x-transition:enter-start="scale-0" x-transition:enter-end="scale-100" x-transition:leave="transition transform duration-300" x-transition:leave-start="scale-100" x-transition:leave-end="scale-0">
                                            <header class="w-full h-40 grid mb-5 flex items-center  ">
                                                <div class=" w-full   grid  bg-white h-20">
                                                    ...
                                                    <h2 class=" font-semibold text-center justify-self-center self-center ">
                                                    Veuillez entrer le contenu du paragraph</h2>
                                            ...
                                            <footer class="">
                                                ...
                                                <div class="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b">
                                                    ...
                                                    <div id="add-preparation" data-id="<?= $vars['entity']->getId() ?>" data-url="<?= $vars['baseUrl'] ?>" class="bg-green-500 ml-5 text-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="button" @click="showModal = false" style="transition: all .15s ease">
                                                        <button  data-id="<?= $vars['entity']->getId() ?>" data-url="<?= $vars['baseUrl'] ?>" class="text-lg text-center  block lg:inline-block lg:mt-0">
                                                            Confirmer
                                                        </button>
                        ...
                        <div class="py-4 lg:px-8 md:px-3 h-full">
                            ...
                            <div class="mb-4 h-full">
                                ...
                                <div class="inline-block w-full mb-5 mt-3">
                                    <input placeholder="Ingrédient" list="ingredient_list" class=" resize-none h-80 w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" id="ingredient" type="text" required />
                                    ...
                                    <span id="ingredient_error" class="text-red-500"> </span>
                                </div>
                                <div class="w-full flex justify-between">
                                    <div class="w-1/3">
                                        <input name="" placeholder="Quantité" class="w-full  appearance-none border rounded py-2 px-3 text-grey-darker" id="quantity" type="number" required>

                                        <span id="quantity_error" class="text-red-500"></span>
                                    </div>
                                    <div class="w-1/3">
                                        <input list="unit_list" name="" placeholder="Unité" class=" w-full appearance-none border rounded py-2 px-3 text-grey-darker" id="unit" type="text" required>
                                        <span id="unit_error" class="text-red-500"></span>
                                    </div>
